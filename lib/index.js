...
if (typeof MODE === 'undefined' || MODE === null) {
  var defaults = {
    ...
    powered_by_img: 'http://cdn.ticketbase.com/widgets/v0.1/assets/powered-by.png',
    site_name: 'Ticketbase'
  };
} else if (MODE === 'pet') {
  var defaults = {
    apihost: 'http://api.pet.ticketbase.com',
    url: 'http://www.pet.ticketbase.com',
    powered_by_img: 'http://cdn.ticketbase.com/widgets/v0.1/assets/powered-by-pet.png',
